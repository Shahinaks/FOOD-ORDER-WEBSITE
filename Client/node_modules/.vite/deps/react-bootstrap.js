...
var Carousel = (
  ...
  React38.forwardRef(({
    ...
    const elementRef = (0, import_react24.useRef)();
    ...
    const intervalHandleRef = (0, import_react24.useRef)();
    (0, import_react24.useEffect)(() => {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react25.useCallback)((...args) => {
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react27.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react30.useContext)(DropdownContext_default);
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react31.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react31.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react31.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react31.useState)(true);
  let value = (0, import_react31.useMemo)(() => ({
  ...
  return (0, import_react31.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react31.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react31.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react31.default).createElement((0, import_react31.default).Fragment, null, props.children);
  }
  return (0, import_react31.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react31.default).useId();
  let [didSSR] = (0, import_react31.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react31.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react31.default)["useSyncExternalStore"] === "function") return (0, import_react31.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react31.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
var Context = (0, import_react34.createContext)(canUseDOM_default ? window : void 0);
...
function Dropdown({
  ...
  const context6 = (0, import_react35.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react36.useLayoutEffect : import_react36.useEffect;
...
var Switch = React75.forwardRef((props, ref) => (0, import_jsx_runtime69.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function useCallbackRef2() {
  return (0, import_react53.useState)(null);
}
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react58.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var Modal = (0, import_react60.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime81.jsx)(import_jsx_runtime81.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime81.jsxs)(import_jsx_runtime81.Fragment, {
...
var Modal2 = React95.forwardRef(({
  ...
  const renderBackdrop = (0, import_react62.useCallback)((backdropProps) => (0, import_jsx_runtime89.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React106.forwardRef(({
  ...
  const renderBackdrop = (0, import_react68.useCallback)((backdropProps) => (0, import_jsx_runtime100.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React107.forwardRef(({
  onHide,
  ...props
}, ref) => {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime117.jsxs)(import_jsx_runtime116.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react75.cloneElement)(children, triggerProps), (0, import_jsx_runtime115.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React119.forwardRef(({
    children,
    ...props
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime130.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime130.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime130.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
